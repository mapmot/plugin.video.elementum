...
from elementum.kodiutils import upnext_signal
...
class ElementumRPCServer(BaseHandler):
    ...
    def AddonFailure(self, addonId):
        if ADDON.getSetting("provider_disable_failing") == "false":
            return 0
